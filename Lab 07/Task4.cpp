...
private:
    ...
    int enrollmentYear;
public:
    Student(string n, string i, string a, string p, string e, string courses[], double g, int year) : Person(n, i, a, p, e), GPA(g), enrollmentYear(year) 
    {
        for (int j = 0; j < 5; j++)
        {
...
class Professor : public Person
{
    private:
        ...
        double salary;
    public:
        Professor(string n, string i, string a, string p, string e, string dept, string courses[], double s) : Person(n, i, a, p, e), department(dept), salary(s) 
        {
            for (int j = 0; j < 3; j++)
            {
...
class Staff : public Person 
{
    private:
        ...
        double salary;
    public:
        Staff(string n, string i, string a, string p, string e, string dept, string pos, double s) : Person(n, i, a, p, e), department(dept), position(pos), salary(s) {}
...
int main() 
{
    ...
    course1.registerStudent(student1);# include <iostream>
#include <string>
using namespace std;
